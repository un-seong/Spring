...
public class AjaxController {
	...
	@GetMapping("/ajax01")
	public String ajax01(String email, String context) throws IOException {
		System.out.println(email + ", " + context);
		int row = mailService.sendMail(email, context);
	...
	public int ajax03(@RequestBody HashMap<String, String> param) {
		// @RequestBody : HTML 규칙에 상관없이 넘어 오는 값을 그대로 요청으로 인식한다 
