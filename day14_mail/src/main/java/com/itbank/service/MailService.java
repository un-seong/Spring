...
public class MailService {
	...
	public int sendMail(String dst, String text) throws IOException {
		...
		try {
			mimeMessage.setFrom(new InternetAddress("jwsabout@naver.com"));		// 보내는 사람
			mimeMessage.setRecipient(Message.RecipientType.TO, new InternetAddress(dst));	// 받는 사람
			mimeMessage.setSubject("[KGITBANK] 인증번호 입니다");
